...
public class InterceptionRulesFragment extends PreferenceFragment implements OnPreferenceClickListener, OnPreferenceChangeListener {
    ...
    public boolean onPreferenceChange(Preference pref, Object objValue) {
        if (pref == mAllContactsPreference) {
        	if(mAllContactsPreference.isChecked()){
        		mStrangerPreference.setChecked(false);
        		System.putIntForUser(mContext.getContentResolver(),PreferenceUtils.KEY_STRANGER_ALL, 0, ActivityManager.getCurrentUser());
        		mOnlyAllowWhitePreference.setChecked(false);
        		System.putIntForUser(mContext.getContentResolver(),PreferenceUtils.KEY_STRANGER_ALL, 0, ActivityManager.getCurrentUser());
        	}
